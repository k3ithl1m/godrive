...
import {GDText, AvatarWithName} from "godrive-ui";
import InfoSection from "../../detail/components/InfoSection";
    ...
    return (
      <View
        ...
        <View style = {{justifyContent: "center", alignItems :"center"}}>
          <GDText textStyle = {{margin: 20, fontSize: 30}} >CREATE</GDText>
        </View>
          ...
          <View style = {styles.invite}>
            ...
            <View style = {{flexDirection: "row", justifyContent: "center"}}>
              {list.map((l, i) => <AvatarWithName name = {l.name} image = {l.image} key = {i}/>)}
            </View>
        </View>
      </View>
    )
